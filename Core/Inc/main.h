...
/* Private defines -----------------------------------------------------------*/
#define KL_15_Pin GPIO_PIN_12
#define KL_15_GPIO_Port GPIOB
...
#define Crank_Pin GPIO_PIN_8
#define Crank_GPIO_Port GPIOA
#define Cam_Pin GPIO_PIN_9
#define Cam_GPIO_Port GPIOA
#define SW_KL15_Pin GPIO_PIN_10
#define SW_KL15_GPIO_Port GPIOA
